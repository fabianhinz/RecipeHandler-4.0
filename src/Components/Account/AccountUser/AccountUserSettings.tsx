                        ...
                        secondary={
                            <>
                                ...
                                <Collapse in={showInfo}>
                                    <Typography gutterBottom variant="body2" color="textSecondary">
                                        Den Augen zu liebe gibt es ein sogenanntes <i>Darktheme</i>.
                                        Dem Nutzer zuliebe auch ein <i>Lighttheme</i>. Bei{' '}
                                        <i>Dynamisch</i> entscheidet das Betriebssystem über das
                                        Design.
                                    </Typography>
                                </Collapse>
                            </>
                    ...
                    <ListItemText
                        ...
                        secondary={
                            <>
                                ...
                                <Collapse in={showInfo}>
                                    <Typography gutterBottom variant="body2" color="textSecondary">
                                        Je nach Bildschirmgröße werden die am häufigsten gekochte
                                        Rezepte unabhängig von Autor oder Filterung durch die
                            ...
                            <>
                                ...
                                <Collapse in={showInfo}>
                                    <Typography variant="body2" gutterBottom color="textSecondary">
                                        ...
                                        starten und enden werden als ganze Sätze interpretiert. Über
                                        den <b>Bindestrich</b> können Wörter explizit aus der Suche
